    ...
    <section id="home" className="pt-24 bg-primary-gradient">
      <div className="container mx-auto px-4 py-16 md:py-24 relative">
        ...
        <div className="absolute bottom-0 w-full left-0 h-16 overflow-hidden">
          <img src="./images/realistic-paw-trail.svg" alt="" className="w-full object-contain" />
        </div>
              ...
              <div className="absolute left-0 md:left-8 lg:left-16 hidden sm:block" style={{ height: "30px", width: "120px", top: "50%", transform: "translateY(-50%)" }}>
                <div className="paw-print-animated" 
                     style={{ 
                       left: '0px', 
                       top: '-5px',
                       backgroundImage: "url('./images/paws/realistic-paw1.svg')",
                ...
                <div className="paw-print-animated" 
                     style={{ 
                       left: '40px', 
                       top: '-2px',
                       backgroundImage: "url('./images/paws/realistic-paw2.svg')",
                ...
                <div className="paw-print-animated" 
                     style={{ 
                       left: '80px', 
                       top: '-8px',
                       backgroundImage: "url('./images/paws/realistic-paw3.svg')",
              ...
              <div className="absolute right-0 md:right-8 lg:right-16 hidden sm:block" style={{ height: "30px", width: "120px", top: "50%", transform: "translateY(-50%)" }}>
                <div className="paw-print-animated" 
                     style={{ 
                       right: '0px', 
                       top: '-7px',
                       backgroundImage: "url('./images/paws/realistic-paw4.svg')",
                       transform: "rotate(12deg)",
                       animation: "pawFloat 3s ease-in-out infinite",
                       animationDelay: "0.2s"
                     }}></div>
