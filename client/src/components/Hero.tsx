        ...
        <div className="text-center mb-12 relative">
          ...
          <div className="flex justify-center mb-6">
            <a 
              ...
              className="font-bubble px-8 py-3 text-white rounded-full transition duration-200 flex items-center justify-center gap-2 shadow-lg hover:shadow-xl"
              style={{ 
              ...
              onMouseOver={(e) => {
                ...
                e.currentTarget.style.boxShadow = "0 10px 25px rgba(204, 0, 0, 0.4)";
              }}
              onMouseOut={(e) => {
